...
public class stepDefinitions extends BaseTest{
	...
	public void user_is_on(String pageNmae) {
		...
		if(pageNmae.equalsIgnoreCase("LoginPage"))
		{
			page =new LoginPage();
		}
		else if(pageNmae.equalsIgnoreCase("RegistrationPage"))
		{
			page= new RegistrationPage();
		}
		else if(pageNmae.equalsIgnoreCase("SearchHotelPage"))
		{
	...
	@Given("user luanch app using url {string}")
	public void user_luanch_app_using_url(String url) {
	...
	public void user_enters_details_in_new_user_registration_form2(DataTable dataTable) {
		...
		driver.findElement(By.xpath("//input[@name='full_name']")).sendKeys(dataMapList.get(0).get("fullname"));
